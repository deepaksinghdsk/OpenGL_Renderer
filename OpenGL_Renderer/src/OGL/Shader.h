	...
	*/
	...
	public:
		...
		*/
		...
		/*
			Created a shader from a string of shader code
		...
		*/
		...
		/*
			@result The shader's object ID, as returned form glCreateShader
		*/
		GLuint object() const;

		//ogl::Shader objects can be copied and assigned becuase they are reference conted
